...
class CoreGrammar(ConditionGrammar):
    ...
    def rename(self):
        ...
        """
        params = self.identifier ^ (Optional(self.identifier) +
    ...
    def assignment(self):
        ...
        assignment ::= relation_name assign expression |
            ...
            assign expression
        """ 
        # FIXME: using self.identifier instead of self.relation_name as relation_name does not recognize any relations not yet in schema
        lhs = Group(self.identifier +
