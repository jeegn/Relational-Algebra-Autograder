...
class BaseTranslator:
    ...
    def __init__(self):
        self._translate_functions = {
            ...
            Operator.theta_right_outer_join: self.theta_right_outer_join,
            Operator.theta_left_outer_join: self.theta_left_outer_join,
            Operator.theta_full_outer_join: self.theta_full_outer_join
        }
